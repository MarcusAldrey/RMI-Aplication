...
public class GUITheme {
  ...
  private static Font getFont (String fileName) {
    try {
      return Font.createFont (Font.TRUETYPE_FONT, new FileInputStream (new File ("C:\\Users\\Marcus Aldrey\\git\\MI-Concorrencia\\PBL4-Redes\\src\\view\\" + fileName))).deriveFont (14f);
    }
    catch (IOException e) {
